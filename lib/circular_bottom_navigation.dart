...
//  var widgetAPasar = widget.tabItems[pos].icon

      double scaleFactor = pos == selectedPos ? 1.2 : 1.0;
      Widget cualWidget = pos == 1 ? Badge(
      badgeContent: Text(widget.tabItems[pos].cuantos,style: TextStyle(color: Colors.white),),
      child: Icon(
